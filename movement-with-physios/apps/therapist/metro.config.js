 ...
 *        package.json `exports` field doesn't expose `./index`. Bypass
 *        Node's exports check by resolving to the literal file inside
 *        the nested v6 under react-native-webrtc.
 * FIX 2: @clerk/clerk-expo 2.x pulls react-dom (web-only). Stub for native.
 */
