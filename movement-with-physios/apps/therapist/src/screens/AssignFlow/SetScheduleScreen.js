...
// ── Helpers ──────────────────────────────────────────────────────────────────
// MONTHS / getDaysInMonth / getFirstDayOfWeek moved into the extracted
// CalendarPicker (P3.4). formatDate stays here — it's used by the start-date
// summary field below, not the calendar itself.
const MONTHS = [
